...
@dso_cache = dso_local local_unnamed_addr global [504 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 420684754, ; hash 0x191323d2, from name: libaot-signinwithgoogle.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 478691741, ; hash 0x1c88419d, from name: libaot-signinwithgoogle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-signinwithgoogle.dll.so
		ptr null; void* handle (0x0)
	}, ; 56
	...
	%struct.DSOCacheEntry {
		i64 1443284271, ; hash 0x5606c52f, from name: signinwithgoogle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-signinwithgoogle.dll.so
		ptr null; void* handle (0x0)
	}, ; 161
	...
	%struct.DSOCacheEntry {
		i64 1560742816, ; hash 0x5d070ba0, from name: aot-signinwithgoogle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-signinwithgoogle.dll.so
		ptr null; void* handle (0x0)
	}, ; 174
	...
	%struct.DSOCacheEntry {
		i64 2573587476, ; hash 0x9965d414, from name: aot-signinwithgoogle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-signinwithgoogle.dll.so
		ptr null; void* handle (0x0)
	}, ; 294
	...
	%struct.DSOCacheEntry {
		i64 2737514922, ; hash 0xa32b29aa, from name: signinwithgoogle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-signinwithgoogle.dll.so
		ptr null; void* handle (0x0)
	}, ; 324
